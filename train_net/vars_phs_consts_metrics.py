...
def definePhVar(th):
    ...
    return weights,biases,x,y,ph_is_training

def performanceMetrics(x,y,weights,biases,th,ph_is_training): #,is_training):
    ...
    optimizer = tf.train.AdamOptimizer(learning_rate=th['learning_rate']).minimize(cost)
