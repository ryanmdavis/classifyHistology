...
df_path='/home/ryan/Documents/Datasets/classify_histology/augmented3/test_dataset_database_info.pkl'

extract.showRandomImages(df_path,cancer=False,aug=False,title=True)