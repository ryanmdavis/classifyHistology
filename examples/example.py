...
augmentation_hyperparameters={
    ...
    'rotate_deg':range(-20, 25, 5),
    'translate_pix_rc':range(-5,10,5),
    'reflect_horiz':1,
    'mov_avg_win':100,
...
#data_df_loc=extract.rwImages('/media/ryan/002E-0232/nanozoomer_images/Dataset',augmentation_hyperparameters)
#extract.rwImages('/media/ryan/002E-0232/nanozoomer_images/Dataset/Patient101_10-12-2017/Patient101-tumor-1-',augmentation_hyperparameters)
