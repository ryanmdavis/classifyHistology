# file downloaded from https://gist.github.com/wchargin/31eee50b9aaebf387b380f70054575c5
...
def main():
  ...
  run_names_list = ['Output07-27-22AM-December-22-2018','Output09-25-37AM-December-22-2018','Output11-23-33AM-December-22-2018']
  run_names = (x for x in run_names_list)
  #tag_names = ('temperature/current/scalar_summary', 'delta/scalar_summary')
  tag_names = ('prob10', 'prob6', 'prob4')

  logdir = '/home/ryan/Dropbox/Code/classifyHistology/TensorBoard/'
